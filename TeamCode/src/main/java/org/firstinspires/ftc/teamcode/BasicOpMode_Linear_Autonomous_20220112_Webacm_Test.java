...
@Autonomous(name="OpenCV Webcam Test 01/12", group="Linear Opmode")
//@Disabled
public class BasicOpMode_Linear_Autonomous_20220112_Webacm_Test extends LinearOpMode {
...
// Start the camera and call grabFrame, process the frame, and call deinit
        ...
        AtomicReference<TeamMarkerPosition> teamMarkerPosition =
                new AtomicReference<>(TeamMarkerPosition.UNKNOWN);
//        Thread worker =
//                new Thread(
//                        () -> {
//                            webcam.start();
...
//
//            elementDropLevelDegrees = 5650;
//
//        }else if (elementDropLevel == 3){
//
//            elementDropLevelDegrees = 6640;
//            //0.4
//
//        }else{
//            elementDropLevelDegrees = 4500;
