...
@Autonomous(name="Autonomous 02/11", group="Linear Opmode")
//@Disabled
public class BasicOpMode_Linear_Autonomous_20220211 extends LinearOpMode {
    ...
    private final DcMotor arm = null;
    private final DcMotor linearArm = null;
    ...
    private final double wristMax = 0.858;
    private final double wristMin = 0.204;
    ...
    public void runOpMode() {
        ...
        if (ControlHub_VoltageSensor.getVoltage() > 13.5){
            voltageSpeed = 0.4;
            voltageTime = 1450;
        }else if (ControlHub_VoltageSensor.getVoltage() < 13.5 && ControlHub_VoltageSensor.getVoltage() > 12.5){
            voltageSpeed = 0.6;
            voltageTime = 1500;
        }else if (ControlHub_VoltageSensor.getVoltage() < 12.6){
            voltageSpeed = 0.75;
            voltageTime = 1900;
        }
...
//        }
        ...
        if (elementDropLevel == 1) {
            ...
            elementDropLevelDegrees = 5770;

        }else if (elementDropLevel == 3){

            elementDropLevelDegrees = 6760;
            //0.4
        ...
        if (AllianceColor == "red") {
            if (autonomousSimplicity) {
                ...
                sleep(1000);
                move_forward(-0.3, 600);
                move_forward(0.35, 900);
                sleep(1000);
